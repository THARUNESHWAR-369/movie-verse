...
export const NavComponent = () => {
    return (
        <div className="nav w-full p-3 flex align-middle justify-between items-center pt-8">
            <div className="appName pl-10">
                <a href="/" className="font-bold text-red-600 tracking-wider text-4xl">MOVIE VERSE</a>
            </div>
